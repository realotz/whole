...
type Data struct {
	...
	Cert     *Data_Cert     `protobuf:"bytes,3,opt,name=cert,proto3" json:"cert,omitempty"`
}
...
func (x *Data_Cert) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_Cert) ProtoMessage() {}

func (x *Data_Cert) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_Cert.ProtoReflect.Descriptor instead.
func (*Data_Cert) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{2, 2}
}

func (x *Data_Cert) GetKey() []byte {
	if x != nil {
		return x.Key
	}
	return nil
...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x22, 0xa0, 0x04, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x35, 0x0a, 0x08, 0x64, 0x61, 0x74,
	...
	0x0a, 0x04, 0x63, 0x65, 0x72, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x6b,
	0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x2e, 0x43,
	0x65, 0x72, 0x74, 0x52, 0x04, 0x63, 0x65, 0x72, 0x74, 0x1a, 0x3a, 0x0a, 0x08, 0x44, 0x61, 0x74,
	...
	0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x12, 0x3c, 0x0a, 0x0c, 0x64, 0x69, 0x61,
	...
	0x6d, 0x65, 0x6f, 0x75, 0x74, 0x1a, 0x2c, 0x0a, 0x04, 0x43, 0x65, 0x72, 0x74, 0x12, 0x10, 0x0a,
	...
	0x65, 0x72, 0x74, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_Cert)(nil),         // 7: kratos.api.Data.Cert
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	7,  // 6: kratos.api.Data.cert:type_name -> kratos.api.Data.Cert
