...
//登出
func (s *EmployeeService) Logout(ctx context.Context, req *pb.NullReq) (*pb.NullReply, error) {
	panic("implement me")
}

//发送验证码
func (s *EmployeeService) Captcha(ctx context.Context, req *pb.CaptchaReq) (*pb.NullReply, error) {
	panic("implement me")
}

// 获取当前登录用户id
func (s *EmployeeService) UserInfo(ctx context.Context, req *pb.NullReq) (*pb.Employee, error) {
