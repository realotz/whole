...
func (wu *WechatUpdate) SetOwner(m *Member) *WechatUpdate {
	return wu.SetOwnerID(m.ID)
}
...
func (wu *WechatUpdate) ClearOwner() *WechatUpdate {
...
func (wu *WechatUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if wu.mutation.OwnerCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   wechat.OwnerTable,
			Columns: []string{wechat.OwnerColumn},
			Bidi:    false,
...
// SetOwnerID sets the "owner" edge to the Member entity by ID.
func (wuo *WechatUpdateOne) SetOwnerID(id int64) *WechatUpdateOne {
	wuo.mutation.SetOwnerID(id)
	return wuo
}

// SetNillableOwnerID sets the "owner" edge to the Member entity by ID if the given value is not nil.
func (wuo *WechatUpdateOne) SetNillableOwnerID(id *int64) *WechatUpdateOne {
	if id != nil {
...
// SetOwner sets the "owner" edge to the Member entity.
func (wuo *WechatUpdateOne) SetOwner(m *Member) *WechatUpdateOne {
	return wuo.SetOwnerID(m.ID)
}
...
// ClearOwner clears the "owner" edge to the Member entity.
func (wuo *WechatUpdateOne) ClearOwner() *WechatUpdateOne {
