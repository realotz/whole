...
func (UnimplementedEmployeeServiceServer) Logout(context.Context, *comm.NullReq) (*comm.NullReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Logout not implemented")
}
func (UnimplementedEmployeeServiceServer) UserInfo(context.Context, *comm.NullReq) (*Employee, error) {
...
func (UnimplementedEmployeeServiceServer) Delete(context.Context, *EmployeeDeleteOption) (*comm.NullReply, error) {
